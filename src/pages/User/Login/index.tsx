      ...
      >
        <LoginForm
          ...
          logo={
            <img
              alt="logo"
              src="https://as2.ftcdn.net/v2/jpg/03/31/93/85/1000_F_331938599_nmkc39B7E74s1G5P01b0YCJ6x0MNMqJz.jpg"
            />
          }
          title="Ecommerce"
            ...
            items={[
              {
                ...
                label: intl.formatMessage({
                  ...
                  defaultMessage: 'Đăng nhập mật khẩu tài khoản',
                }),
              },
              {
                key: 'mobile',
                label: intl.formatMessage({
                  ...
                  defaultMessage: 'Đăng nhập số điện thoại di động',
                }),
              },
            ]}
          />
          ...
          {status === 'error' && loginType === 'account' && (
            <LoginMessage
              content={intl.formatMessage({
                ...
                defaultMessage: 'Sai tài khoản hoặc mật khẩu(admin/ant.design)',
              })}
            />
          )}
          {type === 'account' && (
            <>
              <ProFormText
                ...
                placeholder={intl.formatMessage({
                  ...
                  defaultMessage: 'Tên tài khoản: admin or user',
                })}
                rules={[
                  {
                    required: true,
                ...
                rules={[
                  {
                    ...
                    message: (
                      <FormattedMessage
                        ...
                        defaultMessage="Vui lòng nhập mật khẩu của bạn!"
                      />
                    ),
                  },
                ]}
